...
const activeHome = (isPlay) => {
  return (
    <View style={{ width: 40, height: 40 }}>
      <LottieView source={require(`./assets/images/bar.json`)} autoPlay={isPlay} loop={false} />
    </View>
  )
}
...
const activeList = (isPlay) => {
  return (
    <View style={{ width: 40, height: 40 }}>
      <LottieView source={require(`./assets/images/cart.json`)} autoPlay={isPlay} loop={false} />
    </View>
  )
}
...
const activeCamera = (isPlay) => {
  return (
    <View style={{ width: 40, height: 40 }}>
      <LottieView source={require(`./assets/images/search.json`)} autoPlay={isPlay} loop={false} />
    </View>
  )
}
...
const activeNotification = (isPlay) => {
  return (
    <View style={{ width: 40, height: 40 }}>
      <LottieView source={require(`./assets/images/setting.json`)} autoPlay={isPlay} loop={false} />
    </View>
  )
}
...
const activeUser = (isPlay) => {
  return (
    <View style={{ width: 40, height: 40 }}>
      <LottieView source={require(`./assets/images/user.json`)} autoPlay={isPlay} loop={false} />
    </View>
  )
}
